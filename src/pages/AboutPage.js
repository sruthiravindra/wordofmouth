    ...
    return (
        <Container>
            ...
            <div className='code-links'>
                <a href='https://github.com/sruthiravindra/wordofmouth' target='_blank'>Frontend Code</a>
                <a href='https://github.com/effieguenther/wordofmouth_server' target='_blank'>Backend Code</a>
            </div>
            <Row>
                ...
                <p className='author'>- Built by: <span className='bold'>Sruthi</span></p>
                <p>
                ...
                <p className='author'>- Built by: <span className='bold'>Effie</span></p>
                ...
                <p className='author'>- Built by: <span className='bold'>Sruthi + Effie</span></p>
                ...
                <p><span className='feature'>User Session Restore</span></p>
                <p><span className='feature'>'Keep me logged in' Button</span></p>
                <p><span className='feature'>Delete Account:</span></p>
                <p><span className='feature'>Update User email/phone and password</span></p>
                <p><span className='feature'>Option to delete request that the user sent</span></p>
                <p><span className='feature'>Email/phone buttons will email/call on click</span></p>
                ...
                <p><span className='feature'>Different Registration as Worker vs. Customer</span></p>
                <p><span className='feature'>Email/text sent on account creation:</span></p>
                <p><span className='feature'>User can view all the reviews they have written</span></p>
                <p><span className='feature'>User can edit reviews which they have writte</span></p>
                ...
                <p><span className='feature'>Email/text sent on account deletion:</span></p>
                <p><span className='feature'>Password recovery</span></p>
